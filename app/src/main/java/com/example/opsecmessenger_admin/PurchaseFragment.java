...
public class PurchaseFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        calculator.setOnTouchListener((view1, motionEvent) -> {

            if(motionEvent.getAction() == MotionEvent.ACTION_UP) {
                if(motionEvent.getRawX() >= calculator.getRight() - calculator.getTotalPaddingRight()) {
                    // your action for drawable click event
                    int add=Integer.parseInt( calculator.getText().toString())+1;
...
//        });
    ...
    @Override
    public void onClick(View view) {
        Navigation.findNavController(view).navigate(R.id.action_purchaseFragment_to_paymentMethodFragment);
    }
